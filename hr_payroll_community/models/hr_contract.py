...
class HrContract(models.Model):
    ...
    benefit_ids = fields.One2many(
        'hr.contract.salary.benefit', 'contract_id',
    ...
    def get_cnaps_ceiling(self, base):
        """Retourne la base de calcul CNAPS/OSTIE après application du
        plafond mutualisé de la société (montant SME * multiplicateur)."""
        self.ensure_one()
        ceiling = self.company_id.sme_amount * \
            self.company_id.cnaps_ceiling_multiplier
        if not ceiling:
            return base
