...
class HrSalaryRule(models.Model):
    ...
    debit_account_id = fields.Many2one(
        'account.account', string='Compte à débiter',
        help="Compte comptable débité lors de la génération de l'écriture "
             "comptable du bulletin pour cette règle.")
    credit_account_id = fields.Many2one(
        'account.account', string='Compte à créditer',
        help="Compte comptable crédité lors de la génération de l'écriture "
             "comptable du bulletin pour cette règle.")
