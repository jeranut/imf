...
#############################################################################
{
    ...
    'depends': ['hr_contract', 'hr_holidays', 'account'],
    ...
    'data': [
        ...
        'wizard/declaration_salaires_wizard_views.xml',
        'wizard/salary_attachment_wizard_views.xml',
        'wizard/salary_benefit_wizard_views.xml',
